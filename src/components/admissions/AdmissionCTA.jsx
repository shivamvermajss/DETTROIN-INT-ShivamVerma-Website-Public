 ...
 * Section Call to Action encouraging online registration, campus visit booking, or brochure download.
 */
const AdmissionCTA = () => {
  const { cta } = admissionData;
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <Link to={cta.secondaryPath} className="focus:outline-none">
          <Button
            ...
            icon={Calendar}
            iconPosition="left"
            aria-label="Schedule a campus visit to Pavna School"
          >
            {cta.secondaryText}
          </Button>
        </Link>
