...
/**
 * LeadershipHighlights Component
 * Displays 4 leadership pillar highlight cards (Student Success, Global Perspective, Parent Partnership, Innovative Learning).
 */
const LeadershipHighlights = () => {
  const { highlights } = leadershipData;

  return (
    <div className="my-16 lg:my-20">
      <div className="text-center mb-8">
        <h3 className="text-2xl sm:text-3xl font-extrabold text-[#123458] tracking-tight mb-2">
          Leadership Pillars & Principles
        </h3>
        <p className="text-sm sm:text-base text-slate-600">
          Core values driving our administrative and pedagogical excellence.
        </p>
      </div>
