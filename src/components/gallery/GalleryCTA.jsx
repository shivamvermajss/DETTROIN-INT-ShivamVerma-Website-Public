 ...
 * Call to Action component inviting visitors for a live campus tour or full photo exploration.
 */
const GalleryCTA = () => {
  const { cta } = galleryData;
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <Link to={cta.primaryPath} className="focus:outline-none">
          <Button
            ...
            icon={Calendar}
            iconPosition="left"
            aria-label="Book a campus visit at Pavna International School"
          >
            {cta.primaryText}
          </Button>
        </Link>
        ...
        <Link to={cta.secondaryPath} className="focus:outline-none">
          <Button
            ...
            icon={ArrowRight}
            iconPosition="right"
            aria-label="Explore full gallery and school details"
          >
            {cta.secondaryText}
          </Button>
        </Link>
