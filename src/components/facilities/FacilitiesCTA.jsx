...
/**
 * FacilitiesCTA Component
 * Renders the primary section call-to-action inviting parents for campus visits or admissions inquiry.
 */
const FacilitiesCTA = () => {
  const { cta } = facilityData;
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <Link to={cta.primaryPath} className="focus:outline-none">
          <Button
            ...
            icon={Calendar}
            iconPosition="left"
            aria-label="Schedule a visit to Pavna International School"
          >
            {cta.primaryText}
          </Button>
        </Link>
        ...
        <Link to={cta.secondaryPath} className="focus:outline-none">
          <Button
            ...
            icon={PhoneCall}
            iconPosition="left"
            aria-label="Contact Pavna School admissions team"
          >
            {cta.secondaryText}
          </Button>
        </Link>
